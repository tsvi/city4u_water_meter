...
def parse_arguments():
    ...
    parser.add_argument(
        "--username", 
        help="Your City4U username (overrides config file)"
    )
    parser.add_argument(
        "--password", 
        help="Your City4U password (overrides config file)"
    )
    parser.add_argument(
        "--customer-id", 
        help="Your City4U customer ID (overrides config file)"
    )
    parser.add_argument(
        "--meter-number", 
...
def main():
    ...
    output_file = args.output or config.get("output_file", "water_consumption_data.json")
